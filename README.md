...
Change genre weight from 2.0 to 0.5 and see if mood becomes more important
Test with a "Study Session" profile (lofi, chill, energy: 0.3)
Add tempo_bpm to the scoring formula
